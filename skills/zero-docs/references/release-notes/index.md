...
- [Zero 1.5: Schema Change Improvements and Client Group Auth](/docs/release-notes/1.5)
- [Zero 1.4: Performance and Reliability Improvements](/docs/release-notes/1.4)
- [Zero 1.3: Faster Initial Sync and Other Perf Improvements](/docs/release-notes/1.3)
- [Zero 1.2: IVM Performance and Bug Fixes](/docs/release-notes/1.2)
- [Zero 1.1: Replication Monitoring](/docs/release-notes/1.1)
- [Zero 1.0: First Stable Release](/docs/release-notes/1.0)
- [Zero 0.26: Schema Backfill and Scalar Subqueries](/docs/release-notes/0.26)
- [Zero 0.25: DX Overhaul, Query Planning](/docs/release-notes/0.25)
- [Zero 0.24: Join Flipping, Cookie Auth, Inspector Updates](/docs/release-notes/0.24)
