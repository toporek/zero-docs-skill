...
* Support nested property access in JWT auth tokens ([docs](../deprecated/rls-permissions.md#rules)).
* Make initial sync configurable ([docs](../zero-cache-config.md#initial-sync-table-copy-workers)).
* Add query result type to SolidJS ([docs](../queries.md#partial-data))
