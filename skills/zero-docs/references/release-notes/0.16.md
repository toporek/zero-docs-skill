...
* Documented how to use lambdas to deploy permissions in SST, rather than needing CI/CD to have access to Postgres. ([doc](../self-host.md) – search for " `permissionsDeployer`").
* Added simple debugging logs for read and write permissions ([doc](../deprecated/rls-permissions.md#debugging)).
